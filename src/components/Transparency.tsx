      ...
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-in">
          ...
          <p className="text-lg text-gray-700">
            We believe in complete transparency. If we can't eat it ourselves, we won't give it to your dog.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="w-full md:w-1/2 animate-fade-in">
            <div className="aspect-square max-w-md mx-auto rounded-full overflow-hidden border-8 border-nutty-light relative">
              <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1501286353178-1ec871214838')] bg-cover bg-center"></div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 space-y-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="bg-nutty-light/30 rounded-lg p-6 border-l-4 border-nutty-accent">
              ...
              <p className="text-gray-700 mb-4">
                Every ingredient in our products meets human consumption standards. We source premium ingredients that we would eat ourselves.
              </p>
            ...
            <div className="bg-nutty-light/30 rounded-lg p-6 border-l-4 border-nutty-accent">
              <h3 className="text-xl font-bold mb-4">Clean Label Commitment</h3>
              <p className="text-gray-700 mb-4">
                Our Clean Label commitment means ingredients you can recognize and trust. We're transparent about everything that goes into our products.
              </p>
              <div className="flex items-center gap-4 mt-6">
                ...
                <div>
                  <h4 className="font-bold">Scan for Full Transparency</h4>
                  <p className="text-sm text-gray-600">Scan our product QR code to see detailed nutritional information and sourcing details</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mt-16">
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 text-center animate-fade-in">
            ...
            <p className="text-sm text-gray-600">Developed with and approved by certified veterinary nutritionists</p>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 text-center animate-fade-in" style={{ animationDelay: '0.1s' }}>
            ...
            <p className="text-sm text-gray-600">Every batch is tested for quality and safety before distribution</p>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 text-center animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            <h4 className="font-bold mb-2">Sustainably Sourced</h4>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 text-center animate-fade-in" style={{ animationDelay: '0.3s' }}>
            ...
            <p className="text-sm text-gray-600">Full visibility into our manufacturing and quality control processes</p>
          </div>
        </div>
      </div>
    </section>
